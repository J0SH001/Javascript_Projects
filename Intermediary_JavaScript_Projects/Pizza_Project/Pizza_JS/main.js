...
function getVegetable(runningTotal, text1) {
    ...
    for (var n = 0; n < vegetableArray.length; n++) {
        if (vegetableArray[n].checked) {
            selectedVegetable.push(vegetableArray[n].value);
            console.log("selected vegetable item: ("+vegetableArray[n].value+")");
            text1 = text1 + vegetableArray[n].value + "<br>";
        }
    }
    ...
    console.log("total selected vegetable item: "+ vegetableCount);
