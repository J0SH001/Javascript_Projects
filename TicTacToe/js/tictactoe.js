...
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't benn selected already.
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        if (activePlayer === 'X'){
            ...
            select.style.backgroundImage = 'url("images/brown.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/black.png")';
        }
...
function checkWinConditions(){
    ...
    // X 6, 7, 8 condition.
    else if (arrayIncludes('6X', '7X', '8X')) { drawWinLine(50, 450, 558, 450)}
    // X 0, 3, 6 condition.
    else if(arrayIncludes('0X', '3X', '6X')) {drawWinLine(100, 50, 100, 558)}
    // X 1, 4, 7 condition.
    else if(arrayIncludes('1X', '4X', '7X')) {drawWinLine(304, 50, 304, 558)}
    // X 2, 5, 8 condition.
    else if (arrayIncludes('2X', '5X', '8X')) { drawWinLine(450, 50, 450, 558)}
    // X 6, 4, 2 condition.
    else if (arrayIncludes('6X', '4X', '2X')) { drawWinLine(100, 450, 510, 90)}
    // X 0, 4, 8 condition.
    ...
    // O 6, 7, 8 condition.
    else if(arrayIncludes('6O', '7O', '8O')) {drawWinLine(50, 450, 558, 450)}
    // O 0, 3, 6 condition.
    else if(arrayIncludes('0O', '3O', '6O')) {drawWinLine(100, 50, 100, 558)}
    // O 1, 4, 7 condition.
    else if(arrayIncludes('1O', '4O', '7O')) {drawWinLine(304, 50, 304, 558)}
    // O 2, 5, 8 condition.
    else if (arrayIncludes('2O', '5O', '8O')) { drawWinLine(450, 50, 450, 558)}
    // O 6, 4, 2 condition.
    else if (arrayIncludes('6O', '4O', '2O')) { drawWinLine(100, 450, 510, 90)}
    // O 0, 4, 8 condition.
